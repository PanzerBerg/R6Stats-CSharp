...
namespace R6Stats.ui
{
    public partial class CircularProgressBar : UserControl
    {
        ...
        private void CircularProgressBar_Paint(object sender, PaintEventArgs e)
        {
            ...
            Pen obj_pen = new Pen(Color.FromArgb(54,54,54));
            ...
            e.Graphics.FillPie(new SolidBrush(Color.FromArgb(54, 54, 54)), rectangle, 0, (int)(this.progress * 3.6));

            obj_pen = new Pen(Color.DimGray);
            rectangle = new Rectangle(0 - this.Width / 2 + 25, 0 - this.Height / 2 + 25, this.Width - 50, this.Height - 50);
            e.Graphics.DrawPie(obj_pen, rectangle, 0, 360);
            e.Graphics.FillPie(new SolidBrush(Color.DimGray), rectangle, 0, 360);
            ...
            e.Graphics.DrawString(counter , new Font("Sans Serif", 18), new SolidBrush(Color.FromArgb(54, 54, 54)), rectangle, ft);
